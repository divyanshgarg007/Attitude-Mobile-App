...
const CategoryItemsView = (props) => {
    ...
    const callApi = () => {
        let { actions } = props;
        actions.getCategoryProduct({ id: `${item._attrs.id}&start=0&count=${PAGE_SIZE}` }, onSuccess, onError);
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(CategoryItemsView)
